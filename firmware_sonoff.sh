...
# Found here: https://community.home-assistant.io/t/sonoffs-zigbee-3-0-usb-dongle-plus-firmware/420558/30?u=honeypotleopard
# Script Here: https://github.com/mmattel/Raspberry-Pi-Setup/blob/main/scripts/firmware_sonoff.sh
